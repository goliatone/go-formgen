...
// Loader fetches JSON Schema documents from different sources (filesystem, fs.FS,
// HTTP). Implementations live under internal/jsonschema but satisfy this contract.
type Loader interface {
	Load(ctx context.Context, src Source) (schema.Document, error)
}

// LoaderOptions configures how a Loader resolves sources.
...
// WithHTTPClient injects a custom HTTP client for remote JSON Schema documents.
